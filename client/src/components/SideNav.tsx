...
export default function SideNav() {
    ...
    return (
        <div className="absolute left-8 top-50 bottom-50 flex flex-col justify-center gap-5 z-100">
            {routes.map((r, index) => (
                <NavButton
                    key={r.path}

        ...
        <>
            ...
            <div className="bg-white px-8">
                <div className="bg-gray-400/40 p-5 rounded-3xl mb-8">
                    <h2 className="text-title font-bold px-5">
                        {news.title}
                    </h2>
                </div>
                <div className="text-body opacity-80 whitespace-pre-line mx-10 pb-10">
            ...
            <div className="relative w-full h-17">
                ...
                <div className="absolute inset-0 flex top-1">
                    <p className="absolute font-semibold text-body opacity-70 left-11">
                        {news.date}
                    </p>
                    <p className="absolute font-semibold italic text-body opacity-70 right-12">
                        {news.author}
                    </p>
                </div>
            </div>
